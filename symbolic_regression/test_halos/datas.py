...
def create_graph(pos_file, other_file, r, num_catalog, param):
    ...
    if param == "sigma8":
        y = float(np.loadtxt("/scratch/gpfs/hshao/Rockstar/same_seed/ABACUS/params.txt", usecols=1))
        ...
        y = float(np.loadtxt("/scratch/gpfs/hshao/Rockstar/same_seed/ABACUS/params.txt", usecols=0))
...
def create_dataset(num_catalogs, r, param, particles):
    ...
    if param == "sigma8":
        ...
        for i in range(num_catalogs):
            pos_file = "/scratch/gpfs/hshao/Rockstar/same_seed/ABACUS/%d/halos_pos_%d.npy"%(i, particles)
            mass_file = "/scratch/gpfs/hshao/Rockstar/same_seed/ABACUS/%d/halos_mass_%d.npy"%(i, particles)
        ...
        for i in range(num_catalogs):
            pos_file = "/scratch/gpfs/hshao/Rockstar/same_seed/ABACUS/%d/halos_pos_%d.npy"%(i, particles)
            vel_file = "/scratch/gpfs/hshao/Rockstar/same_seed/ABACUS/%d/halos_vel_%d.npy"%(i, particles)
